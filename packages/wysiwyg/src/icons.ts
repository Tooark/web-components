// Ícones da toolbar (traços de 24x24 no estilo Lucide), constantes: o único
// HTML que o pacote injeta por innerHTML.
...
export const ICONS = {
  ...
  textColor: svg('<path d="M4 20h16"/><path d="m6 16 6-12 6 12"/><path d="M8 12h8"/>'),
  highlight: svg(
  ...
  video: svg('<rect x="2" y="4" width="14" height="16" rx="2"/><path d="m22 8-6 4 6 4V8z"/>'),
  blockquote: svg(
    '<path d="M10 11H6a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v6a4 4 0 0 1-4 4"/><path d="M20 11h-4a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v6a4 4 0 0 1-4 4"/>'
  ),
...
export type ArkWysiwygIcon = keyof typeof ICONS;
